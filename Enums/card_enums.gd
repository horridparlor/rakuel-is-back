...
const KeywordDescriptions : Dictionary = {
	...
	Keyword.INFERNOID: "...%SAME_TYPE, you may purge %STRONG_TYPE from any grave.",
	...
	Keyword.MINER: "...on an empty stack, mill 2. Draw a card for each rock milled. For each miner milled, repeat this effect.",
...
const KeywordTags : Dictionary = {
	...
	Keyword.INFERNOID: KeywordTag.WHEN_SUPPORTING,
